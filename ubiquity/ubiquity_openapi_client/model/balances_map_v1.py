...
def lazy_import():
    ...
    globals()['BalanceV1'] = BalanceV1


class BalancesMapV1(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """BalancesMapV1 - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([BalanceV1]): Currency balances with asset paths as keys.  # noqa: E501

        Keyword Args:
            value ([BalanceV1]): Currency balances with asset paths as keys.  # noqa: E501
