...
class SmartToken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, contract, *args, **kwargs):  # noqa: E501
        """SmartToken - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, contract, *args, **kwargs):  # noqa: E501
        """SmartToken - a model defined in OpenAPI
