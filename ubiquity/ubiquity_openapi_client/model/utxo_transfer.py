...
class UtxoTransfer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, inputs, outputs, currency, unspent, *args, **kwargs):  # noqa: E501
        """UtxoTransfer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, inputs, outputs, currency, unspent, *args, **kwargs):  # noqa: E501
        """UtxoTransfer - a model defined in OpenAPI
