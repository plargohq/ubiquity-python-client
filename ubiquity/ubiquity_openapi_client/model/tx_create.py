...
def lazy_import():
    ...
    globals()['TxDestination'] = TxDestination


class TxCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, _from, to, index, *args, **kwargs):  # noqa: E501
        """TxCreate - a model defined in OpenAPI

        Args:
            _from (str): The source UTXO or account ID for the originating funds
            to ([TxDestination]): A list of recipients
        ...
        Keyword Args:
            ...
            fee (str): The fee you are willing to pay (required only for Ethereum) for the transaction. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, _from, to, index, *args, **kwargs):  # noqa: E501
        """TxCreate - a model defined in OpenAPI
