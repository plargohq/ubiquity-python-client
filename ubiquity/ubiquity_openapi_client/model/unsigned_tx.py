...
class UnsignedTx(ModelNormal):
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'unsigned_tx': 'unsigned_tx',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, unsigned_tx, *args, **kwargs):  # noqa: E501
        """UnsignedTx - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, unsigned_tx, *args, **kwargs):  # noqa: E501
        """UnsignedTx - a model defined in OpenAPI
