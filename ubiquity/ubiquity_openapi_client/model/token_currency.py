...
class TokenCurrency(ModelNormal):
    ...
    def _from_openapi_data(cls, asset_path, *args, **kwargs):  # noqa: E501
        """TokenCurrency - a model defined in OpenAPI

        Args:
            asset_path (str): Asset path of transferred currency

        Keyword Args:
            type (str): defaults to "token"  # noqa: E501
            ...
            detail (Token): [optional]  # noqa: E501
        """

        type = kwargs.get('type', "token")
