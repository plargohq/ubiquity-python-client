...
def lazy_import():
    ...
    globals()['ReportField'] = ReportField
...
class Report(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'fields': ([ReportField],),  # noqa: E501
            'items': (int,),  # noqa: E501
            'limit': (int,),  # noqa: E501
            'continuation': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fields, items, *args, **kwargs):  # noqa: E501
        """Report - a model defined in OpenAPI

        Args:
            fields ([ReportField]): Transaction items
        ...
        Keyword Args:
            ...
            limit (int): The limit number provided in the request or the default. [optional]  # noqa: E501
            continuation (str): Continuation token to send in the next request if there are more items. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, fields, items, *args, **kwargs):  # noqa: E501
        """Report - a model defined in OpenAPI
