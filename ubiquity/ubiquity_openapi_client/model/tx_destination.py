...
class TxDestination(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, destination, amount, *args, **kwargs):  # noqa: E501
        """TxDestination - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, destination, amount, *args, **kwargs):  # noqa: E501
        """TxDestination - a model defined in OpenAPI
