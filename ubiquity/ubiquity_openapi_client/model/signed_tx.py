...
class SignedTx(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tx, *args, **kwargs):  # noqa: E501
        """SignedTx - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tx, *args, **kwargs):  # noqa: E501
        """SignedTx - a model defined in OpenAPI
