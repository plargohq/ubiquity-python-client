...
class Fee(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, destination, *args, **kwargs):  # noqa: E501
        """Fee - a model defined in OpenAPI

        Args:
            amount (str): Integer string in smallest unit (Satoshis)
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, destination, *args, **kwargs):  # noqa: E501
        """Fee - a model defined in OpenAPI
