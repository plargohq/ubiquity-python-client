...
class PlatformsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_platform_endpoints = _Endpoint(
            settings={
                'response_type': (PlatformDetail,),
                'auth': [
                    'bearerAuth'
            ...
            api_client=api_client,
            callable=__get_platform_endpoints
        )
        ...
        self.get_platforms_list = _Endpoint(
            settings={
                'response_type': (PlatformsOverview,),
                'auth': [
                    'bearerAuth'
