...
class PlatformsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_platform_endpoint = _Endpoint(
            settings={
                'response_type': (PlatformDetail,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/v2/{platform}/{network}',
        ...
        self.get_platform_endpoints_endpoint = _Endpoint(
            settings={
                'response_type': (PlatformDetail,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/v1/{platform}/{network}/',
                'operation_id': 'get_platform_endpoints',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_platforms_endpoint = _Endpoint(
            settings={
        ...
        self.get_platforms_list_endpoint = _Endpoint(
            settings={
                'response_type': (PlatformsOverview,),
                'auth': [
                    'bearerAuth'
                ...
                'endpoint_path': '/v1/',
                'operation_id': 'get_platforms_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_platform(
        ...
        **kwargs
        ...
        kwargs['network'] = \
            network
        return self.get_platform_endpoint.call_with_http_info(**kwargs)

    def get_platform_endpoints(
        self,
        platform,
        network,
        **kwargs
        ...
        >>> thread = api.get_platform_endpoints(platform, network, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['network'] = \
            network
        return self.get_platform_endpoints_endpoint.call_with_http_info(**kwargs)
    ...
    def get_platforms(
        ...
        **kwargs
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_platforms_endpoint.call_with_http_info(**kwargs)
    ...
    def get_platforms_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_platforms_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_platforms_list_endpoint.call_with_http_info(**kwargs)
