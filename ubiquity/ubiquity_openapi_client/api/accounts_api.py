    ...
    def __init__(self, api_client=None):
        ...
        self.get_report_by_address = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/{platform}/{network}/account/{address}/report',
        ...
        def __v2_get_report_by_address(
            self,
            platform,
            network,
            address,
            **kwargs
            ...
            >>> thread = api.v2_get_report_by_address(platform, network, address, async_req=True)
            >>> result = thread.get()
        ...
        self.v2_get_report_by_address = _Endpoint(
            settings={
                'response_type': (Report,),
                'auth': [
                    'bearerAuth'
                ...
                'operation_id': 'v2_get_report_by_address',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
