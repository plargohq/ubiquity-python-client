...
class BlocksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_block_identifiers(
            self,
            platform,
            network,
            **kwargs
        ):
            """Block Identifiers  # noqa: E501

            Get minimal block identifiers from oldest to newest. This call uses pagination.   # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_block_identifiers(platform, network, async_req=True)
            >>> result = thread.get()
        ...
        self.get_block_identifiers = _Endpoint(
            settings={
                'response_type': (BlockIdentifierPage,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/{platform}/{network}/block_identifiers',
                'operation_id': 'get_block_identifiers',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_block_identifiers
        )
